   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "\n",
      "Total trips duration371183985.484\n",
      "Average trips duration 1237.2799516133446\n",
      "\n",
      ...
      "\n",
      "This took 0.014991283416748047 seconds.\n",
      "----------------------------------------\n",
      "Do you want to display five rows of data,please select yes or noyes\n",
      ...
      "\n",
      "    User Type  month week_day  begin_hour  \\\n",
      "0  Subscriber      6      wed           8   \n",
      "1  Subscriber      3      sat          10   \n",
      "2  Subscriber      5      tue           1   \n",
      "3    Customer      4      sun           7   \n",
      "4  Subscriber      6      sat           8   \n",
      "\n",
      "                                                path  \n",
      "0                 14th & Belmont St NW15th & K St NW  \n",
      "1  Yuma St & Tenley Circle NWConnecticut Ave & Yu...  \n",
      "2        17th St & Massachusetts Ave NW5th & K St NW  \n",
      "3  Constitution Ave & 2nd St NW/DOLM St & Pennsyl...  \n",
      "4  Henry Bacon Dr & Lincoln Memorial Circle NWMai...  \n",
      "Do you want to display five rows of data,please select yes or nono\n",
      "Thanks a lot\n",
      "\n",
